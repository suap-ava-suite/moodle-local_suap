...
$string["top_category_idnumber"] = 'Número de identificação da categoria superior';
...
$string["default_student_auth_desc"] = 'Recomendamos que você configure oAuth com SUAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SUAP.';
...
$string["default_teacher_auth_desc"] = 'Recomendamos que você configure oAuth com SUAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SUAP.';
...
$string["default_assistant_auth_desc"] = 'Recomendamos que você configure oAuth com SUAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SUAP.';
...
$string["default_instructor_auth_desc"] = 'Recomendamos que você configure oAuth com SUAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SUAP.';
...
$string["default_former_auth_desc"] = 'Recomendamos que você configure oAuth com SUAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SUAP.';
...
$string["default_moderator_auth_desc"] = 'Recomendamos que você configure oAuth com SUAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SUAP.';
...
$string["generate_report_task"] = 'Criar relatório de cursos autoinstrucionais';
...
$string['accessed'] = 'Acessaram';
$string['never_accessed'] = 'Nunca Acessaram';
$string['pct_access'] = '% Acesso';
$string['final_exam_takers'] = 'Fizeram Avaliação Final';
$string['pct_final_exam_takers'] = '% Fizeram Avaliação Final';
$string['passed'] = 'Aprovados';
$string['failed'] = 'Reprovados';
$string['pct_passed'] = '% Aprovados';
$string['avg_grade'] = 'Nota Média';
$string['with_certificate'] = 'Com Certificado';
$string['eligible_without_certificate'] = 'Aptos sem Cert.';
$string['completed'] = 'Concluídos';
$string['pct_completed'] = '% Concluídos';

// Admin & Integration Views UI
$string['view_integrations'] = 'Visualizar as integrações';
$string['search_placeholder'] = 'Pesquisar...';
$string['timecreated'] = 'Data de Criação';
$string['status'] = 'Status';
$string['viewing_integration'] = 'Visualizando uma integração';
$string['when'] = 'Quando';
$string['logs'] = 'Logs';
$string['view_logs'] = 'Ver logs';
$string['json'] = 'JSON';
$string['admin_title'] = 'SUAP Sync Admin';
$string['unauthorized_access'] = 'Acesso não autorizado';
$string['status_unprocessed'] = 'Não processado';
$string['status_success'] = 'Sucesso';
$string['status_failed'] = 'Falha';
$string['status_unknown'] = 'Desconhecido';
$string['request_not_found'] = 'Solicitação não encontrada.';
$string['no_task_logs_found'] = 'Nenhum log de tarefa encontrado para esta solicitação.';
...
$string['action'] = 'Ação';
$string['open'] = 'Abrir';
$string['request_label'] = 'Solicitação #';
$string['search_label'] = 'Busca: ';
$string['invalid_session'] = 'Sessão inválida. Por favor, tente novamente.';
